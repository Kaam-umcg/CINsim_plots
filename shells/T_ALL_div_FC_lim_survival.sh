...
#SBATCH --job-name=T_ALL_div_FC_lim_survival
#SBATCH --time=5-00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --error=errors/T_ALL_div_FC_lim_survival.err
#SBATCH --output=outputs/T_ALL_div_FC_lim_survival.log

######
# MAKE SURE THIS IS THE CORRECT SCRIPT NAME
######
SCRIPT_NAME="T_ALL_div_FC_lim_survival"
######
# MAKE SURE THIS IS THE CORRECT SCRIPT NAME
######
