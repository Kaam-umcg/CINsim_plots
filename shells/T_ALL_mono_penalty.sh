...
#SBATCH --job-name=T_ALL_mono_penalty
...
#SBATCH --error=errors/T_ALL_mono_penalty.err
#SBATCH --output=outputs/T_ALL_mono_penalty.log

######
# MAKE SURE THIS IS THE CORRECT SCRIPT NAME
######
SCRIPT_NAME="T_ALL_mono_penalty"
######
# MAKE SURE THIS IS THE CORRECT SCRIPT NAME
######
