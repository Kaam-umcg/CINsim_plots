...
#SBATCH --job-name=Fig_4_new_CnFS
...
#SBATCH --error=errors/Figure_4_new_CnFS.err
#SBATCH --output=outputs/Figure_4_new_CnFS.log
...
cp "../scripts/" $TMPDIR -r
cp "../data/Mps1_t302_p3.RData" $TMPDIR
...
# run your script
Rscript $TMPDIR/scripts/Figure_4_new_CnFS.R

# copies all relevant results to SCRATCH
mkdir -p $SCRATCH/CINsim/Figure_4_new_CnFS
cp $TMPDIR $SCRATCH/CINsim/Figure_4_new_CnFS -r