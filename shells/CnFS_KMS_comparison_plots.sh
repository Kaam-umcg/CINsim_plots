...
#SBATCH --job-name=CnFS_KMS_comparison_plots
...
#SBATCH --error=errors/CnFS_KMS_comparison_plots.err
#SBATCH --output=outputs/CnFS_KMS_comparison_plots.log

######
# MAKE SURE THIS IS THE CORRECT SCRIPT NAME
######
SCRIPT_NAME="CnFS_KMS_comparison_plots"
######
# MAKE SURE THIS IS THE CORRECT SCRIPT NAME
######
