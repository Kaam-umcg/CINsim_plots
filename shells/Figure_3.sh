...
#SBATCH --error=errors/Figure_3.err
#SBATCH --output=outputs/Figure_3.log
...
# run your script
Rscript $TMPDIR/Figure_3.R

# copies all relevant results to SCRATCH
mkdir -p $SCRATCH/CINsim/Figure_3
cp $TMPDIR $SCRATCH/CINsim/Figure_3 -r