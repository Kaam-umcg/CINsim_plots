...
#SBATCH --job-name=T_ALL_full_sweep
...
#SBATCH --error=errors/T_ALL_full_sweep.err
#SBATCH --output=outputs/T_ALL_full_sweep.log
...
do
    ...
    sbatch --output="outputs/T_ALL_single_sweep_$surv_FC.log" \
            --error="errors/T_ALL_single_sweep_$surv_FC.err" \
            T_ALL_single_sweep.sh "$surv_FC"
