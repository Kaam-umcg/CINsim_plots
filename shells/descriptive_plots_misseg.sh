...
#SBATCH --job-name=descriptive_plots_misseg
...
#SBATCH --error=errors/descriptive_plots_misseg.err
#SBATCH --output=outputs/descriptive_plots_misseg.log

######
# MAKE SURE THIS IS THE CORRECT SCRIPT NAME
######
SCRIPT_NAME="descriptive_plots_misseg"
######
# MAKE SURE THIS IS THE CORRECT SCRIPT NAME
######
