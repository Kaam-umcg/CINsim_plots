...
#SBATCH --job-name=make_facet_grid_T_ALL
...
#SBATCH --error=errors/make_facet_grid_T_ALL.err
#SBATCH --output=outputs/make_facet_grid_T_ALL.log
...
cp "../scripts/make_facet_grid_T_ALL.R" "$TMPDIR"
...
# run your script
Rscript "$TMPDIR"/make_facet_grid_T_ALL.R

# copies all relevant results to SCRATCH
mkdir -p "$SCRATCH"/CINsim/make_facet_grid_T_ALL
cp "$TMPDIR" "$SCRATCH"/CINsim/make_facet_grid_T_ALL -r
