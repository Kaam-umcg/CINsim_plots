...
#SBATCH --job-name=organoid_CnFS_heatmap
...
#SBATCH --error=errors/organoid_CnFS_heatmap.err
#SBATCH --output=outputs/organoid_CnFS_heatmap.log

######
# MAKE SURE THIS IS THE CORRECT SCRIPT NAME
######
SCRIPT_NAME="organoid_CnFS_heatmap"
######
# MAKE SURE THIS IS THE CORRECT SCRIPT NAME
######
