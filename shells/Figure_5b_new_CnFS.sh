...
#SBATCH --job-name=Fig_5b_new_CnFS
#SBATCH --time=0-10:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --error=errors/Figure_5b_new_CnFS.err
#SBATCH --output=outputs/Figure_5b_new_CnFS.log
...
cd $TMPDIR
# run your script
Rscript $TMPDIR/scripts/Figure_5b_new_CnFS.R

# copies all relevant results to SCRATCH
mkdir -p $SCRATCH/CINsim/Figure_5b_new_CnFS
cp $TMPDIR $SCRATCH/CINsim/Figure_5b_new_CnFS -r