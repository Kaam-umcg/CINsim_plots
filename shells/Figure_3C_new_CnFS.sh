...
#SBATCH --job-name=Fig_3C_new_CnFS
...
#SBATCH --error=errors/Figure_3C_new_CnFS.err
#SBATCH --output=outputs/Figure_3C_new_CnFS.log
...
# run your script
Rscript $TMPDIR/scripts/Figure_3C_new_CnFS.R

# copies all relevant results to SCRATCH
mkdir -p $SCRATCH/CINsim/Figure_3C_new_CnFS
cp $TMPDIR $SCRATCH/CINsim/Figure_3C_new_CnFS -r