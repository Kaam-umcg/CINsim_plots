...
#SBATCH --job-name=Fig_S4a_diploid
#SBATCH --time=4-00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --error=errors/Figure_S4a_diploid.err
#SBATCH --output=outputs/Figure_S4a_diploid.log
...
mkdir -p $SCRATCH/CINsim/Figure_S4a_diploid
cp $TMPDIR $SCRATCH/CINsim/Figure_S4a_diploid -r