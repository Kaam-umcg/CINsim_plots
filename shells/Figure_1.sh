...
#SBATCH --error=errors/Figure_1.err
#SBATCH --output=outputs/Figure_1.log
...
# run your script
Rscript $TMPDIR/Figure_1.R

# copies all relevant results to SCRATCH
mkdir -p $SCRATCH/CINsim/Figure_1
cp $TMPDIR $SCRATCH/CINsim/Figure_1 -r