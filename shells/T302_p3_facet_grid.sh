...
#SBATCH --job-name=T302_p3_facet_grid
...
#SBATCH --error=errors/T302_p3_facet_grid.err
#SBATCH --output=outputs/T302_p3_facet_grid.log

######
# MAKE SURE THIS IS THE CORRECT SCRIPT NAME
######
SCRIPT_NAME="T302_p3_facet_grid"
######
# MAKE SURE THIS IS THE CORRECT SCRIPT NAME
######
