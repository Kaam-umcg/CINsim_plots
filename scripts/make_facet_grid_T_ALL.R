...
data_locations <- list.dirs("/scratch/p319788/CINsim/single_sweep_T_ALL", recursive = FALSE)
...
saveRDS(compiled_data, file.path("/scratch/p319788/CINsim/single_sweep_T_ALL", "combined_results.Rds"))
...
ggsave(filename = file.path(plots_dir_path, "facet_grid_T_ALLs.pdf"),
        plot = p1,
        width = 7,
